        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card mb-3">
                    <img src="<?=base_url('asset/img/profile/') . $detil['image'] ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title"><?= $detil['username'] ?></h5>
                        <p><?= $detil['email'] ?>.</p>
                        <p class="card-text font-weight-bold">Role : <?= $role['role_name']?> </p>
                        <p class="card-text"><small class="text-muted">Member Since : <?= date('d F Y', $detil['date_created']  ) ?></small></p>
                    </div>
                </div>
            </div>
        </div>
